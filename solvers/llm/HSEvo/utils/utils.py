try:
    ...
    try:
        ...
        def completion(model, messages, temperature=1.0, n=1, **kwargs):
            client = OpenAI()
            return client.chat.completions.create(model=model, messages=messages, temperature=temperature, n=n, **kwargs)
    except ImportError:
        completion = None
import os
import logging
